...
export const ContactEmailTemplate = ({name, email, preview, message}: ContactEmailTemplateProps) => {
  return (
    <Html>
      <Head />
      ...
      <Body style={main}>
        <Container style={container}>
          <Section style={logo}>
            <Img width={40} src={`${baseUrl}/images/logo.svg`} />
            {/* <Image src={peymanLogo} alt="Peyman Eskandari" class="w-10" /> */}
          </Section>
          ...
          <Section style={content}>
            <Text style={paragraph}>Hi Peyman,</Text>
